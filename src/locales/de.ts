...
export const de = {
  ...
  shareInvite: {
    ...
    pageSubtitleTask: "Speichere diese Erinnerung in deinem Konto.",
    pageSubtitleIdea: "Speichere diese Notiz in deinem Konto.",
    pageSubtitleGeneric: "Speichere dieses Element in deinem Konto.",
    ...
    messageLine1Task: "{{name}} möchte, dass du dir Folgendes merkst:",
    messageLine1Idea: "{{name}} möchte, dass du diese Notiz speicherst:",
    messageLine1Generic: "{{name}} möchte das mit dir teilen:",
  },

  sharedListInvite: {
    pageTitle: "Geteilte Liste hinzufügen",
    pageSubtitle: "Prüfe die Liste und entscheide, ob du beitreten möchtest.",
    loading: "Geteilte Liste wird geladen…",
    invalidLinkTitle: "Ungültige Einladung",
    goHome: "Zur Startseite",
    someone: "Jemand",
    messageLine1: "{{name}} möchte diese Liste mit dir teilen:",
    permissionLabel: "Berechtigung",
    roleEditor: "Darf bearbeiten",
    roleViewer: "Nur lesen",
    previewTitle: "Vorschau",
    emptyList: "Diese Liste hat noch keine Einträge.",
    expiresAt: "Läuft ab",
    acceptCta: "Liste beitreten",
    accepting: "Beitritt läuft…",
    acceptError: "Der Beitritt zur Liste ist fehlgeschlagen. Bitte versuche es erneut.",
  ...
  profile: {
    ...
    languageSpanish: "ES Spanisch",
    languageEnglish: "GB Englisch",
    ...
    avatarSelectorOpen: "Avatar wählen",
    avatarUploadPick: "Bild auswählen",
    avatarSelectorTitle: "Avatar auswählen",
    avatarSelectorDescription: "Wähle einen Avatar und seine Hintergrundfarbe.",
    avatarSelectorControls: "Wähle Avatar und Hintergrundfarbe",
    avatarSelectorBg: "Hintergrundfarbe",
    avatarSelectorAvatars: "Avatare",
    avatarSelectorSave: "Avatar speichern",
    avatarSelectorSaving: "Wird gespeichert...",
    avatarSelectorSaved: "Avatar gespeichert.",
    avatarSelectorMissing: "Der ausgewählte Avatar wurde nicht gefunden.",
  ...
  lists: {
    ...
    confirmDelete: "Diese Liste löschen?",
    confirmDeleteItem: "Möchtest du diesen Punkt wirklich löschen?",
    delete: "Löschen",
    leave: "Verlassen",
    deleted: "Liste gelöscht.",
    left: "Du hast die Liste verlassen.",
    deleteError: "Liste konnte nicht gelöscht werden.",
    leaveError: "Die Liste konnte nicht verlassen werden.",
    confirmLeave: "Diese Liste verlassen?",
    onlyOwnerDelete: "Nur der Owner kann diese Liste löschen.",
    share: "Teilen",
    linkCopied: "Link kopiert.",
    shareError: "Freigabelink konnte nicht erstellt werden.",
    inviteAccepted: "Geteilte Liste hinzugefügt.",
    inviteError: "Einladung konnte nicht angenommen werden.",
    notificationsOn: "Benachrichtigungen für diese Liste aktiviert.",
    notificationsOff: "Benachrichtigungen für diese Liste deaktiviert.",
    ...
    newItemPlaceholder: "Punkt hinzufügen...",
    ...
    itemDeleteError: "Punkt konnte nicht gelöscht werden.",
    itemsLoadError: "Punkte konnten nicht geladen werden.",
    loadError: "Listen konnten nicht geladen werden.",
    renameError: "Titel konnte nicht geändert werden.",
    renamePrompt: "Neuer Listenname:",
    duplicateConfirm: "Doppelter Punkt, trotzdem hinzufügen?",
    duplicateConfirmDetailed:
      'Doppelter Punkt. "{{item}}" existiert bereits in der Liste "{{list}}". Trotzdem hinzufügen?',
    iconPrompt: "Wähle ein Emoji für diese Liste (leer = entfernen):",
    iconAction: "Icon ändern",
  ...
  sharedListNotifications: {
    ...
    subtitle: "Letzte Aktivität in geteilten Listen, Erinnerungen und Notizen.",
    open: "Benachrichtigungen",
    close: "Schließen",
    clear: "Löschen",
    empty: "Es gibt noch keine geteilte Aktivität.",
    now: "Jetzt",
    someone: "Jemand",
    itemFallback: "dieses Element",
    listFallback: "diese Liste",
    sharedItemFallback: "dieses Element",
    sharedReminderLabel: "Geteilte Erinnerung",
    sharedNoteLabel: "Geteilte Notiz",
    receivedReminderLabel: "Erhaltene Erinnerung",
    receivedNoteLabel: "Erhaltene Notiz",
    itemAdded: "{{actor}} hat \"{{item}}\" zur Liste \"{{list}}\" hinzugefügt.",
    itemDeleted: "{{actor}} hat \"{{item}}\" aus der Liste \"{{list}}\" gelöscht.",
    itemDeletedUnknown: "{{actor}} hat ein Element aus der Liste \"{{list}}\" gelöscht.",
    itemAssignedSelf: "{{actor}} hat sich \"{{item}}\" aus der Liste \"{{list}}\" selbst zugewiesen.",
    itemAssignedOther: "{{actor}} hat \"{{item}}\" in der Liste \"{{list}}\" an {{assignee}} zugewiesen.",
    itemAssigned: "{{actor}} hat \"{{item}}\" in der Liste \"{{list}}\" zugewiesen.",
    itemUnassigned: "{{actor}} hat die Zuweisung von \"{{item}}\" in der Liste \"{{list}}\" entfernt.",
    itemCompleted: "{{actor}} hat \"{{item}}\" in der Liste \"{{list}}\" als erledigt markiert.",
    itemReopened: "{{actor}} hat \"{{item}}\" in der Liste \"{{list}}\" wieder aktiviert.",
    itemRenamed: "{{actor}} hat \"{{previous}}\" in der Liste \"{{list}}\" in \"{{next}}\" umbenannt.",
    listRenamed: "{{actor}} hat die Liste \"{{previous}}\" in \"{{next}}\" umbenannt.",
    memberJoined: "{{actor}} hat die Liste \"{{list}}\" angenommen.",
    shareSentTask: "Du hast die Erinnerung \"{{item}}\" geteilt.",
    shareSentIdea: "Du hast die Notiz \"{{item}}\" geteilt.",
    shareAcceptedTaskBy: "{{actor}} hat die Erinnerung \"{{item}}\" angenommen.",
    shareAcceptedIdeaBy: "{{actor}} hat die Notiz \"{{item}}\" angenommen.",
    shareRejectedTaskBy: "{{actor}} hat die geteilte Erinnerung \"{{item}}\" abgelehnt.",
    shareRejectedIdeaBy: "{{actor}} hat die geteilte Notiz \"{{item}}\" abgelehnt.",
    shareExpiredTask: "Die geteilte Erinnerung \"{{item}}\" ist abgelaufen.",
    shareExpiredIdea: "Die geteilte Notiz \"{{item}}\" ist abgelaufen.",
    shareReceivedTask: "{{actor}} hat die Erinnerung \"{{item}}\" mit dir geteilt.",
    shareReceivedIdea: "{{actor}} hat die Notiz \"{{item}}\" mit dir geteilt.",
  },
