...
export const en = {
  ...
  shareInvite: {
    ...
    pageSubtitleTask: "Save this reminder to your account.",
    pageSubtitleIdea: "Save this note to your account.",
    pageSubtitleGeneric: "Save this item to your account.",
    loading: "Loading…",
    ...
    messageLine1Task: "{{name}} wants you to remember:",
    messageLine1Idea: "{{name}} wants you to save this note:",
    messageLine1Generic: "{{name}} wants to share this with you:",
  },

  sharedListInvite: {
    pageTitle: "Add shared list",
    pageSubtitle: "Review the list and decide whether you want to join it.",
    loading: "Loading shared list…",
    invalidLinkTitle: "Invalid invitation",
    goHome: "Back to home",
    someone: "Someone",
    messageLine1: "{{name}} wants to share this list with you:",
    ...
    acceptCta: "Join list",
    accepting: "Joining…",
    acceptError: "Couldn't join the list. Please try again.",
  ...
  lists: {
    ...
    leave: "Leave",
    left: "You left the list.",
    leaveError: "Could not leave the list.",
    confirmLeave: "Leave this list?",
    share: "Share",
  ...
  sharedListNotifications: {
    title: "Notifications",
    subtitle: "Recent activity in shared lists, reminders, and notes.",
    open: "Notifications",
    close: "Close",
    clear: "Clear",
    empty: "There is no shared activity yet.",
    now: "Now",
    someone: "Someone",
    itemFallback: "this item",
    listFallback: "this list",
    sharedItemFallback: "this item",
    sharedReminderLabel: "Shared reminder",
    sharedNoteLabel: "Shared note",
    receivedReminderLabel: "Received reminder",
    receivedNoteLabel: "Received note",
    itemAdded: "{{actor}} added \"{{item}}\" to the list \"{{list}}\".",
    itemDeleted: "{{actor}} deleted \"{{item}}\" from the list \"{{list}}\".",
    itemDeletedUnknown: "{{actor}} deleted an item from the list \"{{list}}\".",
    itemAssignedSelf: "{{actor}} assigned \"{{item}}\" to themselves in the list \"{{list}}\".",
    itemAssignedOther: "{{actor}} assigned \"{{item}}\" to {{assignee}} in the list \"{{list}}\".",
    itemAssigned: "{{actor}} assigned \"{{item}}\" in the list \"{{list}}\".",
    itemUnassigned: "{{actor}} removed the assignment from \"{{item}}\" in the list \"{{list}}\".",
    itemCompleted: "{{actor}} marked \"{{item}}\" as done in the list \"{{list}}\".",
    itemReopened: "{{actor}} reopened \"{{item}}\" in the list \"{{list}}\".",
    itemRenamed: "{{actor}} renamed \"{{previous}}\" to \"{{next}}\" in the list \"{{list}}\".",
    listRenamed: "{{actor}} renamed the list \"{{previous}}\" to \"{{next}}\".",
    memberJoined: "{{actor}} accepted the list \"{{list}}\".",
    shareSentTask: "You shared the reminder \"{{item}}\".",
    shareSentIdea: "You shared the note \"{{item}}\".",
    shareAcceptedTaskBy: "{{actor}} accepted the reminder \"{{item}}\".",
    shareAcceptedIdeaBy: "{{actor}} accepted the note \"{{item}}\".",
    shareRejectedTaskBy: "{{actor}} rejected the shared reminder \"{{item}}\".",
    shareRejectedIdeaBy: "{{actor}} rejected the shared note \"{{item}}\".",
    shareExpiredTask: "Your shared reminder \"{{item}}\" expired.",
    shareExpiredIdea: "Your shared note \"{{item}}\" expired.",
    shareReceivedTask: "{{actor}} shared the reminder \"{{item}}\" with you.",
    shareReceivedIdea: "{{actor}} shared the note \"{{item}}\" with you.",
  },
